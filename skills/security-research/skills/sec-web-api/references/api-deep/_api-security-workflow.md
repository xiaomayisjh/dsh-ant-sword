...
1. `NOW`: 读取 `../../../../references/scope-and-evidence.md` — 确认本 skill 的操作是已授权的常规操作
2. `NOW`: 确认当前任务是否命中本 skill 的适用范围
3. `NEXT`: 读取 `../../../../references/environment-and-resources.md`，校验工具可用性和实际路径
...
- [ ] 我是否基于 `../../../../references/environment-and-resources.md` 使用了真实工具路径？
