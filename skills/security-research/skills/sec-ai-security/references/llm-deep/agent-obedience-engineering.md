...
| "如果缺工具可以 bootstrap" | **NO EXCUSE**: 缺工具时按 `../../../../references/environment-and-resources.md` 决定替代品或请用户安装 |
| "记得按 experience-index 沉淀经验" | **CHECKLIST ENFORCED**: 任务完成后逐项打勾 Checklist，未完成不得声称任务结束 |
| "应该..." | **MUST** / **MUST NOT** |
...
2. 检查本机是否有所需工具（读 `../../../../references/environment-and-resources.md`）
3. 如果缺工具 → 按 `../../../../references/environment-and-resources.md` 处理
4. 如果有工具 → 开始工作流第一步
...
□ 我按 experience-index 沉淀了经验（如有踩坑）
