---
name: rev-bin-dex-dumper
description: Dump DEX files from running Android apps for unpacking and deobfuscation. Use when analyzing APK packing, class-loader protection, decrypted DEX extraction, or memory DEX dumping over ADB.
---
...
The `panda-dex-dumper` binary is bundled in this module directory. Resolve its absolute path relative to this INSTRUCTIONS.md file:
