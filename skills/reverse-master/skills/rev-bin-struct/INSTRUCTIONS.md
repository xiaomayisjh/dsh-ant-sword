---
name: rev-bin-struct
description: Recover C/C++ data structures from decompiled code and memory access patterns. Use with IDA MCP or IDA-NO-MCP exports when pointer fields, object layouts, vtables, linked lists, callbacks, or nested structs must be inferred.
---
