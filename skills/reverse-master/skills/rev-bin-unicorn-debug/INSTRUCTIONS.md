---
name: rev-bin-unicorn-debug
description: Debug and emulate focused binary code fragments with Unicorn. Use for local function emulation, algorithm decryption, syscall/JNI/libc stubbing, missing-memory recovery, and tracing without running a full target process.
---
