...
// node_modules/.pnpm/use-sync-external-store@1.2.0_react@19.2.8/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/.pnpm/use-sync-external-store@1.2.0_react@19.2.8/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    "use strict";
    if (true) {
      (function() {
        "use strict";
...
// node_modules/.pnpm/use-sync-external-store@1.2.0_react@19.2.8/node_modules/use-sync-external-store/shim/index.js
var require_shim = __commonJS({
  "node_modules/.pnpm/use-sync-external-store@1.2.0_react@19.2.8/node_modules/use-sync-external-store/shim/index.js"(exports, module2) {
    "use strict";
    if (false) {
...
// node_modules/.pnpm/use-sync-external-store@1.2.0_react@19.2.8/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js
var require_with_selector_development = __commonJS({
  "node_modules/.pnpm/use-sync-external-store@1.2.0_react@19.2.8/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    "use strict";
    if (true) {
      (function() {
        "use strict";
        ...
        var useRef2 = React.useRef, useEffect8 = React.useEffect, useMemo6 = React.useMemo, useDebugValue2 = React.useDebugValue;
...
// node_modules/.pnpm/use-sync-external-store@1.2.0_react@19.2.8/node_modules/use-sync-external-store/shim/with-selector.js
var require_with_selector = __commonJS({
  "node_modules/.pnpm/use-sync-external-store@1.2.0_react@19.2.8/node_modules/use-sync-external-store/shim/with-selector.js"(exports, module2) {
    "use strict";
    if (false) {
      module2.exports = null;
    } else {
...
// node_modules/.pnpm/zustand@4.4.0_@types+react@19.2.18_immer@10.1.1_react@19.2.8/node_modules/zustand/esm/traditional.mjs
var import_react = require("react");
var import_with_selector = __toESM(require_with_selector(), 1);

// node_modules/.pnpm/zustand@4.4.0_@types+react@19.2.18_immer@10.1.1_react@19.2.8/node_modules/zustand/esm/vanilla.mjs
var import_meta = {};
...
// node_modules/.pnpm/zustand@4.4.0_@types+react@19.2.18_immer@10.1.1_react@19.2.8/node_modules/zustand/esm/shallow.mjs
...
function normalizeArray(values) {
  return values.map((value, index2) => normalizeImportedMcp(`server-${index2 + 1}`, value));
}
function parseMcpJson(source) {
  ...
  const root2 = parsed;
  const catalog = root2.mcpServers ?? parsed;
...
function replaceServer(servers, index2, value) {
  return servers.map((server, at) => at === index2 ? value : server);
}
function McpConfigEditor({ servers, savedServers, saving, onChange, onSave }) {
  const [mode, setMode] = (0, import_react3.useState)("visual");
  const [selectedIndex, setSelectedIndex] = (0, import_react3.useState)(servers.length === 0 ? -1 : 0);
  const [jsonDraft, setJsonDraft] = (0, import_react3.useState)(() => formatMcpJson(servers));
  const [message, setMessage] = (0, import_react3.useState)();
  const [probes, setProbes] = (0, import_react3.useState)({});
  const [operations, setOperations] = (0, import_react3.useState)({});
  const dirty = !mcpServersEqual(servers, savedServers);
  const issues = (0, import_react3.useMemo)(() => validateMcpServers(servers), [servers]);
  const selected2 = selectedIndex >= 0 ? servers[selectedIndex] : void 0;
  ...
  const update = (index2, value) => {
    const next = replaceServer(servers, index2, value);
    onChange(next);
  ...
  const copy = () => {
    if (selected2 === void 0) return;
    const next = [...servers, copyMcpServer(selected2, servers)];
    onChange(next);
    setJsonDraft(formatMcpJson(next));
    setSelectedIndex(next.length - 1);
  };
  const remove2 = () => {
    if (selected2 === void 0) return;
    const next = servers.filter((_, index2) => index2 !== selectedIndex);
    onChange(next);
    setJsonDraft(formatMcpJson(next));
  ...
  const runtimeAction = async (action) => {
    if (selected2 === void 0) return;
    const name = selected2.serverName;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: RuntimeStatus_default.mcpEditor, "aria-labelledby": "mcp-editor-title", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("header", { className: RuntimeStatus_default.mcpHeader, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h3", { id: "mcp-editor-title", children: "MCP \u670D\u52A1\u5668" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: "\u914D\u7F6E\u672C\u5730 stdio \u6216\u8FDC\u7A0B HTTP MCP \u670D\u52A1\u3002" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: RuntimeStatus_default.modeSwitch, role: "group", "aria-label": "MCP \u7F16\u8F91\u6A21\u5F0F", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", "aria-pressed": mode === "visual", onClick: () => {
          setMode("visual");
        }, children: "\u53EF\u89C6\u5316" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", "aria-pressed": mode === "json", onClick: () => {
          setJsonDraft(formatMcpJson(servers));
          setMode("json");
        }, children: "JSON" })
      ] })
    ] }),
    mode === "json" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: RuntimeStatus_default.jsonEditor, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("label", { htmlFor: "mcp-json-source", children: "MCP JSON" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("textarea", { id: "mcp-json-source", spellCheck: false, value: jsonDraft, onChange: (event) => {
        setJsonDraft(event.target.value);
      }, "aria-describedby": "mcp-json-help" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { id: "mcp-json-help", children: "\u652F\u6301\u76F4\u63A5\u7C98\u8D34 mcpServers \u547D\u540D\u5BF9\u8C61\u3001mcpServers \u6570\u7EC4\u6216\u670D\u52A1\u5668\u6570\u7EC4\u3002\u89E3\u6790\u5931\u8D25\u4E0D\u4F1A\u8986\u76D6\u5F53\u524D\u53EF\u89C6\u5316\u8349\u7A3F\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: RuntimeStatus_default.editorActions, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: importJson, children: "\u5E94\u7528\u5230\u53EF\u89C6\u5316" }) })
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: RuntimeStatus_default.masterDetail, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("aside", { className: RuntimeStatus_default.serverRail, "aria-label": "MCP \u670D\u52A1\u5668\u5217\u8868", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: RuntimeStatus_default.serverRailHeader, children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: "\u670D\u52A1\u5668" }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: add, children: "\u6DFB\u52A0" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { role: "listbox", "aria-label": "MCP \u670D\u52A1\u5668", "aria-activedescendant": selected2 === void 0 ? void 0 : `mcp-server-${selectedIndex}`, children: servers.map((server, index2) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "button",
          {
            id: `mcp-server-${index2}`,
            type: "button",
            role: "option",
            ...
            onKeyDown: (event) => {
              ...
              setSelectedIndex((index2 + step + servers.length) % servers.length);
            },
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: server.serverName || "\u672A\u547D\u540D\u670D\u52A1\u5668" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("small", { children: server.enabled === false ? "\u5DF2\u505C\u7528" : server.transport })
            ]
          },
          `${index2}-${server.serverName}`
        )) }),
        servers.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: "\u5C1A\u672A\u914D\u7F6E\u670D\u52A1\u5668\u3002" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: RuntimeStatus_default.serverDetail, children: selected2 === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: RuntimeStatus_default.emptyDetail, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children: "\u6DFB\u52A0\u670D\u52A1\u5668\u540E\u5728\u6B64\u7F16\u8F91\u8BE6\u60C5\u3002" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: add, children: "\u6DFB\u52A0 MCP \u670D\u52A1\u5668" })
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: RuntimeStatus_default.detailToolbar, children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: RuntimeStatus_default.enableToggle, children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { type: "checkbox", checked: selected2.enabled !== false, onChange: (event) => {
              update(selectedIndex, { ...selected2, enabled: event.target.checked });
            } }),
            "\u542F\u7528"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: copy, children: "\u590D\u5236" }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: remove2, children: "\u5220\u9664" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: RuntimeStatus_default.detailFields, children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { children: [
            "\u540D\u79F0",
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { value: selected2.serverName, onChange: (event) => {
              update(selectedIndex, { ...selected2, serverName: event.target.value });
            } })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { children: [
            "\u4F20\u8F93",
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("select", { value: selected2.transport, onChange: (event) => {
              update(selectedIndex, switchMcpTransport(selected2, event.target.value));
            }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "stdio", children: "stdio" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "sse", children: "HTTP + SSE\uFF08\u65E7\u7248\uFF09" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "streamable-http", children: "Streamable HTTP" })
            ] })
          ] }),
          selected2.transport === "stdio" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { children: [
              "\u547D\u4EE4",
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { value: selected2.command ?? "", onChange: (event) => {
                update(selectedIndex, { ...selected2, command: event.target.value });
              } })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { children: [
              "\u53C2\u6570\uFF08\u6BCF\u884C\u4E00\u9879\uFF09",
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("textarea", { value: (selected2.args ?? []).join("\n"), onChange: (event) => {
                update(selectedIndex, { ...selected2, args: event.target.value.split("\n").map((value) => value.trim()).filter(Boolean) });
              } })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { children: [
              "\u5DE5\u4F5C\u76EE\u5F55",
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { value: selected2.cwd ?? "", onChange: (event) => {
                update(selectedIndex, { ...selected2, cwd: event.target.value });
              } })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(McpKeyValueEditor, { label: "\u73AF\u5883\u53D8\u91CF", value: selected2.env ?? {}, onChange: (value) => {
              update(selectedIndex, withMcpMap(selected2, "env", value));
            } })
          ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { children: [
              "URL",
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { type: "url", value: selected2.url ?? "", onChange: (event) => {
                update(selectedIndex, { ...selected2, url: event.target.value });
              } })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(McpKeyValueEditor, { label: "\u8BF7\u6C42\u5934", value: selected2.headers ?? {}, onChange: (value) => {
              update(selectedIndex, withMcpMap(selected2, "headers", value));
            } })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { children: [
            "\u5DE5\u5177\u8D85\u65F6\uFF08\u6BEB\u79D2\uFF09",
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("input", { type: "number", min: 1, value: selected2.toolCallTimeoutMs ?? 6e4, onChange: (event) => {
              update(selectedIndex, { ...selected2, toolCallTimeoutMs: Number(event.target.value) });
            } })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: RuntimeStatus_default.runtimeActions, children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", disabled: !selected2.serverName || operations[selected2.serverName]?.status === "pending", onClick: () => {
            void runtimeAction("probe");
          }, children: "\u6D4B\u6D3B" }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", disabled: !selected2.serverName || operations[selected2.serverName]?.status === "pending", onClick: () => {
            void runtimeAction("reload");
          }, children: "\u70ED\u91CD\u8F7D" }),
          operations[selected2.serverName] !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { role: "status", "data-state": operations[selected2.serverName]?.status, children: operations[selected2.serverName]?.message })
        ] }),
        probes[selected2.serverName] !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("details", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("summary", { children: [
            "\u5DF2\u53D1\u73B0 ",
            probes[selected2.serverName]?.toolCount,
            " \u4E2A\u5DE5\u5177"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("ul", { children: probes[selected2.serverName]?.tools.map((tool) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("li", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("code", { children: tool.name }),
            tool.description === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("small", { children: tool.description })
          ] }, tool.name)) })
        ] })
      ] }) })
    ] }),
    issues.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("ul", { className: RuntimeStatus_default.validation, "aria-label": "MCP \u914D\u7F6E\u95EE\u9898", children: issues.map((issue, index2) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("li", { children: issue.message }, index2)) }),
    message !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: RuntimeStatus_default.editorMessage, role: "status", children: message }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("footer", { className: RuntimeStatus_default.saveBar, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: dirty ? "\u6709\u672A\u4FDD\u5B58\u66F4\u6539" : "\u6240\u6709\u66F4\u6539\u5DF2\u4FDD\u5B58" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", disabled: !dirty || saving, onClick: reset, children: "\u91CD\u7F6E" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", disabled: !dirty || saving || issues.length > 0, onClick: () => {
        void save();
...
function RuleEditor({ rules, saving, onChange, onSave }) {
  ...
  const selected2 = sorted.find((item) => item.id === selectedId);
  (0, import_react4.useEffect)(() => {
    if (selectedId === "" && sorted.length > 0 && sorted[0] !== void 0) setSelectedId(sorted[0].id);
  }, [selectedId, sorted]);
  const create2 = () => {
    const id2 = `rule-${crypto.randomUUID()}`;
    const next = { id: id2, title: "\u65B0\u89C4\u5219", enabled: true, order: 0, placement: "after-persona", content: "" };
    onChange([...rules, next]);
    setSelectedId(id2);
  };
  const duplicate = () => {
    if (!selected2) return;
    const id2 = `rule-${crypto.randomUUID()}`;
    onChange([...rules, { ...selected2, id: id2, title: `${selected2.title} \u526F\u672C` }]);
    setSelectedId(id2);
  };
  const remove2 = () => {
    if (!selected2) return;
  ...
  const move = (delta) => {
    if (!selected2) return;
    patch({ order: selected2.order + delta });
  };
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: RuntimeStatus_default.editorList, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h3", { children: "Rule \u5217\u8868" }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: RuntimeStatus_default.masterDetail, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("aside", { className: RuntimeStatus_default.serverRail, role: "listbox", "aria-label": "Rule \u5217\u8868", children: [
        sorted.map((item) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("button", { role: "option", "aria-selected": item.id === selectedId, onClick: () => setSelectedId(item.id), children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: create2, children: "+ \u65B0\u589E" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("main", { className: RuntimeStatus_default.serverDetail, children: selected2 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: RuntimeStatus_default.detailFields, children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("label", { children: [
            "\u6807\u9898",
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("input", { value: selected2.title, onChange: (e) => patch({ title: e.target.value }) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("label", { children: [
            "\u542F\u7528",
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("input", { type: "checkbox", checked: selected2.enabled, onChange: (e) => patch({ enabled: e.target.checked }) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("label", { children: [
            "\u4F4D\u7F6E",
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("select", { value: selected2.placement, onChange: (e) => patch({ placement: e.target.value }), children: PLACEMENTS.map((p) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("option", { value: p, children: p }, p)) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("label", { children: [
            "\u987A\u5E8F",
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              ...
              {
                type: "number",
                value: selected2.order,
                onChange: (e) => patch({ order: Number(e.target.value) })
              }
            )
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: () => move(1), children: "order +1" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: () => move(-1), children: "order -1" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("label", { style: { gridColumn: "1 / -1" }, children: [
            "\u6B63\u6587",
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("textarea", { value: selected2.content, onChange: (e) => patch({ content: e.target.value }) })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: RuntimeStatus_default.saveBar, children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: selected2.id }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: duplicate, children: "\u590D\u5236" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: () => setConfirmDelete(true), children: "\u5220\u9664" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", disabled: saving, onClick: () => {
            void onSave();
          }, children: "\u4FDD\u5B58" })
        ] }),
        confirmDelete && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { role: "alertdialog", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: () => setConfirmDelete(false), children: "\u53D6\u6D88" })
        ] })
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: RuntimeStatus_default.editorMessage, children: "\u9009\u62E9\u6216\u65B0\u5EFA\u4E00\u6761\u89C4\u5219" }) })
    ] })
  ] });
}
...
function SkillEditor({ scopeList, onChange: _onChange, onSave }) {
  ...
  const selected2 = list.find((item) => item.id === selectedId);
  const filtered = (0, import_react5.useMemo)(() => list.toSorted((a, b) => a.name.localeCompare(b.name)), [list]);
  (0, import_react5.useEffect)(() => {
    setList(scopeList.map((item) => ({ ...item })));
  }, [scopeList]);
  const newSkill = () => {
    const id2 = `skill-${Date.now()}-${Math.random().toString(36).slice(2)}`;
    const next = {
      id: id2,
      name: "",
      description: "",
  ...
  const saveOverlay = async () => {
    if (!selected2 || !selected2.name.trim()) return;
    setSaving(true);
    try {
      setError(void 0);
      await fetch("/ant-sword/skills/upsert", {
        ...
        headers: { "content-type": "application/json" },
        body: JSON.stringify({
          name: selected2.name.trim(),
          description: selected2.description ?? "",
          whenToUse: selected2.whenToUse,
          modelInvocable: selected2.modelInvocable,
          userInvocable: selected2.userInvocable,
          content: selected2.content
        })
      }).then(async (response) => {
  ...
  const deleteOverlay = async () => {
    ...
    try {
      ...
      const response = await fetch("/ant-sword/skills/delete", {
        method: "POST",
        headers: { "content-type": "application/json" },
        body: JSON.stringify({ name: selected2.name })
      });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("section", { className: RuntimeStatus_default.editorList, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("h3", { children: "Skill \u5217\u8868" }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: RuntimeStatus_default.masterDetail, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("aside", { className: RuntimeStatus_default.serverRail, role: "listbox", "aria-label": "Skill \u5217\u8868", children: [
        filtered.map((item) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          "button",
          {
            role: "option",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", onClick: newSkill, children: "+ \u65B0\u589E" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("main", { className: RuntimeStatus_default.serverDetail, children: selected2 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: RuntimeStatus_default.detailFields, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              ...
              {
                type: "checkbox",
                checked: selected2.modelInvocable,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              ...
              {
                type: "checkbox",
                checked: selected2.userInvocable,
                onChange: (e) => updateSelected("userInvocable", e.target.checked)
              }
            )
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { style: { gridColumn: "1 / -1" }, children: [
            "\u6B63\u6587",
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              "textarea",
              {
                value: selected2.content,
                onChange: (e) => updateSelected("content", e.target.value)
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: RuntimeStatus_default.saveBar, children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { children: selected2.userOwned ? "\u7528\u6237\u8986\u76D6" : "\u53EA\u8BFB\uFF08\u5185\u7F6E\uFF09" }),
          selected2.userOwned && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", disabled: saving, onClick: saveOverlay, children: "\u4FDD\u5B58" }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", disabled: saving, onClick: deleteOverlay, children: "\u5220\u9664" })
          ] })
        ] }),
        error && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: RuntimeStatus_default.installError, children: error })
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: RuntimeStatus_default.editorMessage, children: "\u9009\u62E9\u6216\u65B0\u5EFA\u4E00\u4E2A Skill" }) })
    ] })
  ] });
}
...
function ThinkingPolicyEditor({ policies, saving, onChange, onSave }) {
  ...
  const [providerId, setProviderId] = (0, import_react6.useState)("");
  const [modelId, setModelId] = (0, import_react6.useState)("");
  const [capability, setCapability] = (0, import_react6.useState)();
  const [error, setError] = (0, import_react6.useState)();
  const provider = providers.find((item) => item.id === providerId);
  const selected2 = policies.find((policy) => policy.providerId === providerId && policy.modelId === modelId);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RuntimeStatus_default.editorList, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { children: "\u6E20\u9053\u601D\u8003\u5F3A\u5EA6" }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { children: "\u7EDF\u4E00\u4E94\u6863\u4F1A\u6309\u6A21\u578B\u5B9E\u9645\u66B4\u9732\u7684 effort \u987A\u5E8F\u5355\u8C03\u6620\u5C04\uFF1B\u4E0D\u652F\u6301 reasoning \u7684\u6A21\u578B\u4E0D\u4F1A\u6CE8\u5165\u53C2\u6570\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: RuntimeStatus_default.grid, children: providers.map((item) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("article", { className: RuntimeStatus_default.card, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RuntimeStatus_default.cardTitle, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: item.name }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: item.id })
      ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("fieldset", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("legend", { children: "\u6A21\u578B\u7B56\u7565" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("label", { children: [
        "\u6E20\u9053",
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("select", { value: providerId, onChange: (event) => chooseProvider(event.target.value), children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "", children: "\u9009\u62E9\u6E20\u9053" }),
          providers.map((item) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("option", { value: item.id, children: [
            item.name,
            " (",
            item.id,
            ")"
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("label", { children: [
        "\u6A21\u578B",
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("select", { value: provider?.models.some((item) => item.id === modelId) === true ? modelId : "", onChange: (event) => setModelId(event.target.value), children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "", children: "\u81EA\u5B9A\u4E49\u6A21\u578B ID" }),
          provider?.models.map((item) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("option", { value: item.id, children: [
            item.name,
            " (",
            item.id,
            ")"
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("label", { children: [
        "\u81EA\u5B9A\u4E49\u6A21\u578B ID",
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("input", { value: modelId, onChange: (event) => setModelId(event.target.value.trim()), placeholder: "provider-owned model id" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: RuntimeStatus_default.editorActions, "aria-label": "\u4E94\u6863\u601D\u8003\u5F3A\u5EA6", children: LEVELS.map((level) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        "button",
        {
          type: "button",
          disabled: capability?.supported !== true,
          "aria-pressed": selected2?.level === level.id,
    ...
    policies.map((policy) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("article", { className: RuntimeStatus_default.card, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: RuntimeStatus_default.cardTitle, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: LEVELS.find((level) => level.id === policy.level)?.label })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", onClick: () => remove2(policy), children: "\u5220\u9664\u7B56\u7565" })
    ] }, key(policy))),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: RuntimeStatus_default.editorActions, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", disabled: saving, onClick: () => {
      void onSave();
    }, children: "\u4FDD\u5B58\u601D\u8003\u7B56\u7565" }) })
  ] });
}
...
function apply(ctx) {
  ...
  ctx.effect(() => {
    ...
    refresh();
    const timer2 = setInterval(refresh, 5e3);
    return () => {
      disposed = true;
      clearInterval(timer2);
    };
