...
export interface SnapshotProvider {
  ...
  readonly restore: (cwd: string, ref: string, signal?: AbortSignal) => Promise<{ restored: number }>
  /** Read-only impact of a restore: paths that would be overwritten, paths kept. */
  readonly preview: (cwd: string, ref: string) => Promise<{ overwritten: string[]; kept: string[] }>
}
