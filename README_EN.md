...
Check `skills/tool-index.md` (generated by the refresh command above) to see detected tools.
...
| `skills/tool-index.md` | Local tool status (auto-generated by refresh-tool-index) |
